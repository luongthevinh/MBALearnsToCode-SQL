...
/* 2. The query shows the name and population density
for each country where the area is over 5,000,000 km2.
Population density is not a column in the World table,
but wecan calculate it as population/area.

Modify it to show the name and per capita gdp: gdp/population
for each country where the area is over 5,000,000 km2 */
...
/* 4. Which countries are not too small and not too big?
BETWEEN allows range checking (range specified is inclusive of boundary values).
The example below shows countries with an area of 250,000-300,000 sq. km.

Modify it to show the country and the area for countries with an area between 200000 and 250000. */
